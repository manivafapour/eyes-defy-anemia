...
classification/v2_scripts/train_vit_l_16_palpebral_v2.py`).
...
model_name is "vit_l_16_palpebral_v2" -- keeps outputs/checkpoints and outputs/logs
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="vit_l_16_palpebral_v2",
        n_trials=12,
    )
