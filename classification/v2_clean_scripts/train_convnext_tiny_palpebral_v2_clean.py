...
classification/v2_clean_scripts/train_convnext_tiny_palpebral_v2_clean.py`).
...
The ONLY difference from train_convnext_tiny_palpebral_v2.py is the data: this run
...
model_name is "convnext_tiny_palpebral_v2_clean" -- the _v2_clean suffix (not a
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="convnext_tiny_palpebral_v2_clean",
        n_trials=12,
    )
