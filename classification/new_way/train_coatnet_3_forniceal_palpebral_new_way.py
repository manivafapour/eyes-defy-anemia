...
classification/new_way/train_coatnet_3_forniceal_palpebral_new_way.py`).
...
model_name is "coatnet_3_forniceal_palpebral_new_way" -- the _new_way suffix keeps this roster's
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="coatnet_3_forniceal_palpebral_new_way",
        n_trials=12,
    )
