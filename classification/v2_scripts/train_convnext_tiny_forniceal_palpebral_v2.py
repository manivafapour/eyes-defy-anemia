"""
Entry point (v2 protocol): 12-trial Optuna search for ConvNeXt-Tiny (frozen
...
classification/v2_scripts/train_convnext_tiny_forniceal_palpebral_v2.py`).
...
model_name is "convnext_tiny_forniceal_palpebral_v2" -- keeps outputs/checkpoints and outputs/logs
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="convnext_tiny_forniceal_palpebral_v2",
        n_trials=12,
    )
