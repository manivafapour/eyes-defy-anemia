...
classification/v2_scripts/train_efficientnet_b0_forniceal_palpebral_v2.py`).
...
model_name is "efficientnet_b0_forniceal_palpebral_v2" -- the _v2 suffix keeps outputs/checkpoints and outputs/logs
distinct from the original (pre-dropout, 30-epoch-ceiling) "efficientnet_b0_forniceal_palpebral"
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="efficientnet_b0_forniceal_palpebral_v2",
        n_trials=12,
    )
