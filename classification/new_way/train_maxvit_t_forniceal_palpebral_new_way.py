...
classification/new_way/train_maxvit_t_forniceal_palpebral_new_way.py`).
...
model_name is "maxvit_t_forniceal_palpebral_new_way" -- the _new_way suffix keeps this roster's
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="maxvit_t_forniceal_palpebral_new_way",
        n_trials=12,
    )
