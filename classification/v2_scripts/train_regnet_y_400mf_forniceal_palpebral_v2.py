"""
Entry point (v2 protocol): 12-trial Optuna search for RegNetY-400MF (frozen
...
classification/v2_scripts/train_regnet_y_400mf_forniceal_palpebral_v2.py`).
...
model_name is "regnet_y_400mf_forniceal_palpebral_v2" -- keeps outputs/checkpoints and outputs/logs
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="regnet_y_400mf_forniceal_palpebral_v2",
        n_trials=12,
    )
