...
**Open question at the time:** whether the original collapse was really caused by insufficient loss weighting, or by the v1 alignment's wrong masks (§1.4.1) providing no learnable signal at all. §3.2b's side-by-side design exists partly to help resolve this on clean v2 (§1.4.2) data.
