...
classification/new_way/train_convnext_base_forniceal_palpebral_new_way.py`).
...
model_name is "convnext_base_forniceal_palpebral_new_way" -- the _new_way suffix keeps this roster's
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="convnext_base_forniceal_palpebral_new_way",
        n_trials=12,
    )
