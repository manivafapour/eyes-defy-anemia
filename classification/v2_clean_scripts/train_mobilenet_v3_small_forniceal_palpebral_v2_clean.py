"""
Entry point (v2 protocol, CLEAN DATA): 12-trial Optuna search for MobileNetV3-Small
...
classification/v2_clean_scripts/train_mobilenet_v3_small_forniceal_palpebral_v2_clean.py`).
...
The ONLY difference from train_mobilenet_v3_small_forniceal_palpebral_v2.py is the data: this run
...
model_name is "mobilenet_v3_small_forniceal_palpebral_v2_clean" -- the _v2_clean suffix (not a
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="mobilenet_v3_small_forniceal_palpebral_v2_clean",
        n_trials=12,
    )
