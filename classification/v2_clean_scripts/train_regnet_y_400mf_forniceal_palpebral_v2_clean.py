"""
Entry point (v2 protocol, CLEAN DATA): 12-trial Optuna search for RegNetY-400MF
...
classification/v2_clean_scripts/train_regnet_y_400mf_forniceal_palpebral_v2_clean.py`).
...
The ONLY difference from train_regnet_y_400mf_forniceal_palpebral_v2.py is the data: this run
...
model_name is "regnet_y_400mf_forniceal_palpebral_v2_clean" -- the _v2_clean suffix (not a
...
if __name__ == "__main__":
    run_study(
        arch_name="regnet_y_400mf",
        tissue_type="forniceal_palpebral",
        model_name="regnet_y_400mf_forniceal_palpebral_v2_clean",
        n_trials=12,
    )
