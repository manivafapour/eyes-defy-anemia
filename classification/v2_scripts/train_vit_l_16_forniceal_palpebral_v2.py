"""
Entry point (v2 protocol): 12-trial Optuna search for ViT-L/16 (frozen
...
classification/v2_scripts/train_vit_l_16_forniceal_palpebral_v2.py`).
...
model_name is "vit_l_16_forniceal_palpebral_v2" -- keeps outputs/checkpoints and outputs/logs
...
if __name__ == "__main__":
    run_study(
        ...
        model_name="vit_l_16_forniceal_palpebral_v2",
        n_trials=12,
    )
